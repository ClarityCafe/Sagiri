const SITE_LIST = {
    /**
     * @todo Add indexes that are missing inbetween known ones.
     */
    ...
    3: {
        ...
        URLRegex: /(?:http:\/\/)?doujinshi\.mugimugi\.org\/index\.php?P=BOOK&ID=\d{5}/i
    },
    5: {
        name: 'Pixiv',
...
let tmp = Object.keys(SITE_LIST).map(v => [v, parseInt('1' + '0'.repeat(Number(v)), 2)]);
const MASKS = {};

tmp.forEach(v => MASKS[v[0]] = v[1]);
...
module.exports = {SITE_LIST, RATINGS, PERIODS, MASKS};