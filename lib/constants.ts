  ...
  */
  ...
  5: {
    ...
    getRating: (data: string) => {
      ...
      return match[1].toLowerCase().includes('r-18') ? 3 : 1;
    },
  },
  8: {
  ...
  9: {
    ...
    getRating: (data: string) => [ null, 'Safe', 'Questionable', 'Explicit' ].indexOf(data.match(/<li>Rating: (.*?)<\/li>/i)![1]),
  },
  10: {
    name: 'drawr',
  ...
  12: {
    ...
    getRating: (body: string) => [ null, 'Safe', 'Questionable', 'Explicit' ].indexOf(body.match(/<li>Rating: (.*?)<\/li>/i)![1]),
  },
  13: {
    name: 'Openings.moe',
  ...
  26: {
    ...
    getRating: (body: string) => [ null, 'Safe', 'Questionable', 'Explicit' ].indexOf(body.match(/<li>Rating: (.*?)<\/li>/i)![1].split(' ')[0]),
  },
  27: {
  ...
  30: {
    ...
    getRating: (body: string) => [ null, 'Safe', 'Questionable', 'Explicit' ].indexOf(
      body
...
const tmp = Object.keys(SITE_LIST).map(v => [ v, parseInt(`1${'0'.repeat(Number(v))}`, 2) ]);
